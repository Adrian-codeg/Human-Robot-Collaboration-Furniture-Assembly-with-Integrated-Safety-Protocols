...
void process_cylinder(const std::string& input_pcd, const std::string& output_pcd, tf2_ros::Buffer& tf_buffer)
{
    ...
    cylinder_segmentation.setDistanceThreshold(0.0015); // Set the distance threshold for cylinder //play
    ...
    if(!cylinder_cloud->points.empty()){
        ...
        if (centroid[2] < 1.2 || centroid[2] > 1.4 || row_cy >3) {
...
while (!high_curvature_xyz->empty()) {
   ...
   // Skip circles that are too high
    ...
    std::cout << "Centroid of the circle in world frame: ("
            << centroid_hole[row_hole][0] << ", " << centroid_hole[row_hole][1] << ", " << centroid_hole[row_hole][2] << ")" << std::endl;
    ...
    void closedGripper(trajectory_msgs::JointTrajectory& posture)
    {
        ...
        posture.points.resize(1);
        posture.points[0].positions.resize(1);
        posture.points[0].positions[0] = 0.4; // Close gripper 0.4
    ...
    {
        if (centroid_cylinder[row][0]>0.5)
        {
            centroid_cylinder[row][0]+=0.02;
        }
        ...
        grasps[0].grasp_pose.pose.position.x = centroid_cylinder[row][0]+0.003; // -0.02
        grasps[0].grasp_pose.pose.position.y = centroid_cylinder[row][1]-0.032; // +0.01
        ...
        if (!move_group.pick(object_id2[row], grasps))
        {
    ...
    void attachCollisionObject()
    {
        ...
        attached_object.object.id = object_id2[row]; // cs1
        ...
        ROS_INFO("Applied attached collision object: %s to tool0", object_id2[row].c_str());
    ...
    void detachCollisionObject()
    {
        ...
        attached_object.object.id = object_id2[row];
        planning_scene_interface.applyAttachedCollisionObject(attached_object);
        ROS_INFO("Detached collision object: %s from tool0", object_id2[row].c_str());
    ...
    void ur5_place(moveit::planning_interface::MoveGroupInterface& group)
    {
        ...
        if(centroid_hole[row][0] >0.5)
        {
            centroid_hole[row][0]=centroid_hole[row][0] -0.01;
        ...
        place_location[0].place_pose.pose.position.x = centroid_hole[row][0]; //-0.02
        place_location[0].place_pose.pose.position.y = centroid_hole[row][1]-0.045; // +0.01
        place_location[0].place_pose.pose.position.z = 1.13; // Adjusted height
        ...
        if (!group.place(object_id2[row], place_location))
            {    
    ...
    void attachObject()
    {
        ...
        srv.request.model_name_2 = object_id1[row];
    ...
    {
        collision_objects.resize(10); // Adjusted to match number of objects
        ...
        collision_objects[3].primitives[0].dimensions[0] = 0.2;   // height
        collision_objects[3].primitives[0].dimensions[1] = 0.02;  // radius
        collision_objects[3].primitive_poses.resize(1);
        collision_objects[3].primitive_poses[0].position.x = 0.5;
        collision_objects[3].primitive_poses[0].position.y = 0.6;
        collision_objects[3].primitive_poses[0].position.z = 1.12;
        collision_objects[3].primitive_poses[0].orientation.w = 1.0;
        collision_objects[3].operation = moveit_msgs::CollisionObject::ADD;


        // Small Cylinder (cs3)
        collision_objects[4].id = "cs3";
        collision_objects[4].header.frame_id = "world";
        collision_objects[4].primitives.resize(1);
        collision_objects[4].primitives[0].type = shape_msgs::SolidPrimitive::CYLINDER;
        collision_objects[4].primitives[0].dimensions.resize(2);
        collision_objects[4].primitives[0].dimensions[0] = 0.2;   // height
        collision_objects[4].primitives[0].dimensions[1] = 0.02;  // radius
        collision_objects[4].primitive_poses.resize(1);
        collision_objects[4].primitive_poses[0].position.x = 0.35;
        collision_objects[4].primitive_poses[0].position.y = 0.45;
        collision_objects[4].primitive_poses[0].position.z = 1.12;
        collision_objects[4].primitive_poses[0].orientation.w = 1.0;
        collision_objects[4].operation = moveit_msgs::CollisionObject::ADD;


        // Small Cylinder (cs4)
        collision_objects[5].id = "cs4";
        collision_objects[5].header.frame_id = "world";
        collision_objects[5].primitives.resize(1);
        collision_objects[5].primitives[0].type = shape_msgs::SolidPrimitive::CYLINDER;
        collision_objects[5].primitives[0].dimensions.resize(2);
        collision_objects[5].primitives[0].dimensions[0] = 0.2;   // height
        collision_objects[5].primitives[0].dimensions[1] = 0.02;  // radius
        collision_objects[5].primitive_poses.resize(1);
        collision_objects[5].primitive_poses[0].position.x = 0.2;
        collision_objects[5].primitive_poses[0].position.y = 0.4;
        collision_objects[5].primitive_poses[0].position.z = 1.12;
        collision_objects[5].primitive_poses[0].orientation.w = 1.0;
        collision_objects[5].operation = moveit_msgs::CollisionObject::ADD;

        // Bin Base
        collision_objects[6].id = "bin_base";
        ...
        collision_objects[6].primitives[0].dimensions = {0.5, 1.5, 0.74};
        collision_objects[6].primitive_poses.resize(1);
        collision_objects[6].primitive_poses[0].position.x = -0.6;
        collision_objects[6].primitive_poses[0].position.y = 0.0;
        collision_objects[6].primitive_poses[0].position.z = 0.35;
        collision_objects[6].operation = moveit_msgs::CollisionObject::ADD;

        // Bin 1
        collision_objects[7].id = "bin1";
        collision_objects[7].header.frame_id = "world";
        collision_objects[7].primitives.resize(1);
        collision_objects[7].primitives[0].type = shape_msgs::SolidPrimitive::BOX;
        collision_objects[7].primitives[0].dimensions = {0.4, 0.4, 0.02};
        collision_objects[7].primitive_poses.resize(1);
        collision_objects[7].primitive_poses[0].position.x = -0.6;
        collision_objects[7].primitive_poses[0].position.y = 0.5;
        collision_objects[7].primitive_poses[0].position.z = 0.76;
        collision_objects[7].operation = moveit_msgs::CollisionObject::ADD;

        // Bin 2
        collision_objects[8].id = "bin2";
        collision_objects[8].header.frame_id = "world";
        collision_objects[8].primitives.resize(1);
        collision_objects[8].primitives[0].type = shape_msgs::SolidPrimitive::BOX;
        collision_objects[8].primitives[0].dimensions = {0.4, 0.4, 0.02};
        collision_objects[8].primitive_poses.resize(1);
        collision_objects[8].primitive_poses[0].position.x = -0.6;
        collision_objects[8].primitive_poses[0].position.y = 0.0;
        collision_objects[8].primitive_poses[0].position.z = 0.76;
        collision_objects[8].operation = moveit_msgs::CollisionObject::ADD;

        // Bin 3
        collision_objects[9].id = "bin3";
        collision_objects[9].header.frame_id = "world";
        collision_objects[9].primitives.resize(1);
        collision_objects[9].primitives[0].type = shape_msgs::SolidPrimitive::BOX;
        collision_objects[9].primitives[0].dimensions = {0.4, 0.4, 0.02};
        collision_objects[9].primitive_poses.resize(1);
        collision_objects[9].primitive_poses[0].position.x = -0.6;
        collision_objects[9].primitive_poses[0].position.y = -0.5;
        collision_objects[9].primitive_poses[0].position.z = 0.76;
        collision_objects[9].operation = moveit_msgs::CollisionObject::ADD;
        ...
        while (ros::ok())
        {
            ...
            switch (step)
            {
                case 1: // Add collision objects
                    ...
                    if (centroid_cylinder[2][0] < 0.21) 
                    {   object_id1={"blue_cylinder1", "blue_cylinder2", "blue_cylinder4", "blue_cylinder3"};
                        object_id2={"cs1", "cs2", "cs4", "cs3"};
                ...
                case 5: // Detach
                    ...
                    if (row > 4)
                    {
                        // ROS_INFO("All operations completed, shutting down.");
                        ROS_INFO("Task completed");
                        ros::shutdown();
                        break; // Exit the loop if all operations are done
...
private:
    ...
    std::array<std::array<double, 3>,4> centroid_hole;
    std::array<std::array<double, 3>,4> centroid_cylinder;
    int row = 0;
    // int row_hole = 0;
    
    std::array<std::string, 4> object_id1={"blue_cylinder1", "blue_cylinder2", "blue_cylinder3", "blue_cylinder4"};
    std::array<std::string, 4> object_id2={"cs1", "cs2", "cs3", "cs4"};
